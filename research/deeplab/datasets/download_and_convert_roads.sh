...
cp "${WORK_DIR}/training/images/* ${IMAGE_FOLDER}"
cp "${WORK_DIR}/test_images/* ${IMAGE_FOLDER}"
ls "${WORK_DIR}/training/images/ > ${LIST_FOLDER}/training.txt"
ls "${WORK_DIR}/test_images/ > ${LIST_FOLDER}/val.txt"
